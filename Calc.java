...
public class SciCal extends javax.swing.JFrame 
{
    ...
    try 
    {
        ...
        int n = Integer.parseInt(numbers[0]); // Total number of items
        int r = Integer.parseInt(numbers[1]); // Number of items to choose
...
private double factorial3(int number) {
   ...
   private void factorialsActionPerformed(java.awt.event.ActionEvent evt) {                                           
        try 
    {
        // Read the input from jTextField
        String input = jTextArea1.getText();
        ...
        jTextArea1.setText(String.valueOf(result)); // Display the result in jTextArea1
    } 
    catch (NumberFormatException e) 
    {
        jTextArea1.setText("manaloto.loudel@gordoncollege.edu.ph"); // Display error message for invalid input
    }
}

// Helper method to calculate factorial
private double factorial2(int number) {
    double fact = 1; // Initialize factorial value
    for (int i = 1; i <= number; i++) {
